...
const saleData = {
  ...
  chartData: [
    ...
    [4000, 5600, 9700, 8600, 13000, 10500, 20000, 26000, 18000, 14000, 19000, 18000]
  ],
...
const tradeStat = [
  { title: '下单笔数', value: 123456 },
  { title: '待付款', value: 34567 },
  { title: '待发货', value: 9876 },
  { title: '待退货', value: 34534 },
  { title: '月收入', value: 1231213 },
  { title: '总收入', value: 23123233 }
]

const tradeOverview = {
  month: { value: 55678, prop: 45.33 },
  year: { value: 67890, prop: 61.98 }
}

const tradeTrend = {
  data: [
    { title: '下单笔数', value: 33445 },
    { title: '退货笔数', value: 1234 }
  ],
  chartText: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
  chartData: [
    [5600, 3600, 4000, 5000, 7000, 6400, 8000, 8900, 7300, 6500, 7100, 8200],
    [4000, 5600, 9700, 8600, 13000, 10500, 20000, 26000, 18000, 14000, 19000, 18000]
  ]
